...
- **進場條件**：
  - 多頭進場：多頭趨勢成立 + 前一根 K 棒觸及 MA20，且當前收盤 > max(前一根 Open, 前一根 Close)，同時收盤站上 MA20/MA60
  - 空頭進場：空頭趨勢成立 + 前一根 K 棒觸及 MA20，且當前收盤 < min(前一根 Open, 前一根 Close)，同時收盤跌破 MA20/MA60
- **停損 / 出場條件**：
...
- `trade_images/`：每筆進出場截圖（預設前後各 20 根）
